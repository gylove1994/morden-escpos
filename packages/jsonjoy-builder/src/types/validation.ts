...
import { baseSchema } from './jsonSchema';
...
function getJsonStringType(t: Translation) {
  return z
    .object({
...
function getJsonNumberType(t: Translation) {
  return z
    .object({
...
function getJsonArrayType(t: Translation) {
  return z
    .object({
      minItems: z.optional(
        z
...
function getJsonObjectType(t: Translation) {
  return z
    .object({
